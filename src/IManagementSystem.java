...
public interface IManagementSystem {
	...
	/*
	 * Add a new house with given parameters - number of bedrooms, number of
	 * bathrooms, price per month to the management system
	 *
	...
	/*
	 * Add a new apartment with given parameters - number of bedrooms, number of
	 * bathrooms, price per month, indication whether there's a lift in the
	 * building, floor on which the apartment is, number of floors in the
	 * building to the management system
	 *
	 * @param bedrooms	number of bedrooms
	 * 	
	...
	/*
	 * Search for a place based on the minimum number of bedrooms and max price. Print all the found properties.
	 *
	...
	/*
	 * Organize visit for each property where 5 or more people requested a visit. Print the property details and all client names.
	 *
	 */
